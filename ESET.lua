        ...
        elseif msg_type == 'MSG:Text' then
          ...
          if database:get('bot:cmds'..msg.chat_id_) and not is_mod(msg.sender_user_id_, msg.chat_id_) then
            ...
            --[[if text:match("^[Ss]how edit$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
              ...
              local text = [[*send(msg.chat_id_, msg.id_, 1, '🔃 راهنمای قفل های اصلی :فعال 🔒سازی حالت سخت گیرانه:
Lock strict
🔓غیر فعال سازی:
Unlock strict
🔒فعال سازی قفل اسپم :
...
🔓غیرفعال سازی :
Unlock edit
🔒️فعال سازی نشانه گذاری :
Lock markdown
🔓غیرفعال سازی :
Unlock markdown
🔒️فعال سازی اسم اشاره:
Lock mention
🔓غیرفعال سازی :
Unlock mention
🔒️فعال سازی قفل سنجاق :
Lock pin
🔓غیرفعال سازی :
Unlock pin
...
🔓غیرفعال سازی :
Unlock inline
🔒فعال سازی قفل نوشتار فارسی :
Lock farsi
🔓غیرفعال سازی :
Unlock farsi
🔒فعال سازی قفل نوشتار انگلیسی :
Lock english
🔓غیرفعال سازی :
Unlock english
🔒فعال سازی سرویس تلگرام :
Lock tgservice
🔓غیرفعال سازی :
Unlock tgservice
🔒فعال سازی قفل فلود :
...
🔓غیرفعال سازی :
Unlock location
🔒فعال سازی قفل کلی گروه :
Lock all
🔓غیر فعال سازی :
Unlock all
🔒⏱فعال سازی قفل کلی زماندار:
lock gtime ساعت
✏️مثال:
lock gtime 1
                       BιɢBαɴɢ™!!!*
